...
namespace AM.Data.Migrations
{
    ...
    [Migration("20250221104140_addslotTime")]
    partial class addslotTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AM.ApplicationCore.Models.TimeSlotsModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 14,
                            EndTime = new TimeOnly(2, 35, 0),
                            StartTime = new TimeOnly(2, 20, 0)
                        },
                        new
                        {
                            Id = 15,
                            EndTime = new TimeOnly(2, 55, 0),
                            StartTime = new TimeOnly(2, 40, 0)
                        },
                        new
                        {
                            Id = 16,
                        ...
                        {
                            Id = 17,
                            EndTime = new TimeOnly(3, 35, 0),
                            StartTime = new TimeOnly(3, 20, 0)
                        },
                        new
                        {
                            Id = 18,
                            EndTime = new TimeOnly(3, 55, 0),
                        ...
                        {
                            Id = 20,
                            EndTime = new TimeOnly(4, 35, 0),
                            StartTime = new TimeOnly(4, 20, 0)
                        },
                        new
                        {
                            Id = 21,
                            EndTime = new TimeOnly(4, 55, 0),
                            StartTime = new TimeOnly(4, 40, 0)
                        },
                        new
                        {
                            Id = 22,
                        ...
                        {
                            Id = 23,
                            EndTime = new TimeOnly(5, 35, 0),
                            StartTime = new TimeOnly(5, 20, 0)
                        });
                });
