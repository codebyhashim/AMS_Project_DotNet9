...
namespace AM.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<IdentityUser> signInManager, ILogger<LoginModel> logger, RoleManager<IdentityRole> roleManager, ApplicationDbContext _context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // GET CURRENT USER lOGIN OBJECT
                    //var user = await _signInManager.UserManager.FindByEmailAsync(Input.Email);
                    // CHECK USER CAN ALREADY REGISTERED 
                    //var data = context.Patients.Where(x => x.UserId == user.Id).Count()>0;
                    ...
                    //else
                    //{
                    //    //_logger.LogInformation("User does not exist in PatientModel, redirecting to Create page.");
                    //    _logger.LogInformation("User does not exist in PatientModel, redirecting to Create page.");
